...
const Footer = () => {
   return (
      <div className="relative py-8 overflow-hidden bg-tan">
         <div className="container relative z-10 px-4 mx-auto">
            <div className="flex flex-wrap items-center justify-between -m-8">
               <div className="w-auto p-8">
                  <a href="#">
                     <div className="inline-flex items-center">
                        <span className="ml-4 text-lg text-cream font-bold">
                           Home Food by <span className="text-yellow">Apa Ka Dhaba</span>
                        </span>
                     </div>
                  </a>
               </div>
               <div className="w-auto p-8">
                  <div className="-m-1.5 flex flex-wrap text-cream">
                     <div className="w-auto p-1.5">
                        <a href="https://www.facebook.com/profile.php?id=61574188847793" target="_blank">
               ...
               <div className="w-auto p-8">
                  <a href="#">
                     <div className="inline-flex items-center">
                        <span className="ml-4 text-lg text-yellow font-bold">
                           WhatsApp: <span className="text-cream">+92 312 6268135</span>
                        </span>
                     </div>
                  </a>
               </div>
