         ...
         <div className="px-4 py-5 mx-auto max-w-7xl lg:px-10">
            <div className="max-w-3xl mx-auto text-center">
               ...
               <p className="max-w-2xl mx-auto mt-4 text-xl text-gray-600">
                  At Apa ka Dhaba, success is not just about food, it's about people. From the dedication of our family in preparing fresh home cooked meals, to the trust and love shown by our valued customers, everyone has played a part in this journey. Every dish carries the effort of those working behind the scenes and the smiles of those who enjoy it. Together, they are the true reason behind the success of <span className="text-yellow">Apa ka Dhaba.</span>
               </p>
            </div>
            <br />
